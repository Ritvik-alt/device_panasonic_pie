...
DEVICE_PATH := device/panasonic/pie
...
# Assert
TARGET_OTA_ASSERT_DEVICE := pie

# Partitions
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 13980576 # This is the maximum known partition size, but it can be higher, so we just omit it
